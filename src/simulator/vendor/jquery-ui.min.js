...
!(function (t) {
    ...
    ;(x.cleanData =
        ...
        (x.widget.extend = function (t) {
            for (
                var e, i, s = a.call(arguments, 1), o = 0, n = s.length;
                o < n;
                o++
            )
                for (e in s[o])
        ...
        (x.Widget.prototype = {
            ...
            option: function (t, e) {
                ...
                if ('string' == typeof t)
                    if (
                        ((n = {}), (t = (i = t.split('.')).shift()), i.length)
                    ) {
                        for (
                            s = n[t] = x.widget.extend({}, this.options[t]),
                                o = 0;
                            o < i.length - 1;
                            o++
                        )
        ...
        x.each({ show: 'fadeIn', hide: 'fadeOut' }, function (n, r) {
            x.Widget.prototype['_' + n] = function (e, t, i) {
                ...
                'number' == typeof (t = t || {})
                    ...
                    s && x.effects && x.effects.effect[o]
                        ? e[n](t)
                        : o !== n && e[o]
    ...
    ;(P = Math.max),
        ...
        (x.fn.position = function (p) {
            ...
            var u,
                ...
                t,
                v =
                    'string' == typeof (p = x.extend({}, p)).of
                        ? x(document).find(p.of)
                        : x(p.of),
            ...
            return (
                v[0].preventDefault && (p.at = 'left top'),
                (d = e.width),
                (f = e.height),
        ...
        (x.ui.position = {
            fit: {
                left: function (t, e) {
                    ...
                    e.collisionWidth > o
                        ? 0 < r && a <= 0
                            ? ((i = t.left + r + e.collisionWidth - o - s),
                              (t.left += r - i))
                            : (t.left =
                                  !(0 < a && r <= 0) && a < r
                ...
                top: function (t, e) {
                    ...
                    e.collisionHeight > o
                        ? 0 < r && a <= 0
                            ? ((i = t.top + r + e.collisionHeight - o - s),
                              (t.top += r - i))
                            : (t.top =
                                  !(0 < a && r <= 0) && a < r
            ...
            flip: {
                left: function (t, e) {
                    var i = e.within,
                        ...
                        r = -2 * e.offset[0]
                    a < 0
                        ? ((s = t.left + l + i + r + e.collisionWidth - o - s) <
                              0 ||
                              s < C(a)) &&
                          (t.left += l + i + r)
                        : 0 < h &&
                ...
                top: function (t, e) {
                    var i = e.within,
                        ...
                        r = -2 * e.offset[1]
                    a < 0
                        ? ((s = t.top + l + i + r + e.collisionHeight - o - s) <
                              0 ||
                              s < C(a)) &&
                          (t.top += l + i + r)
                        : 0 < h &&
    ...
    x.widget('ui.draggable', x.ui.mouse, {
        ...
        _getHandle: function (t) {
            return (
                !this.options.handle ||
                !!x(t.target).closest(this.element.find(this.options.handle))
                    .length
            )
        },
                ...
                e &&
                    (this.containment &&
                        ...
                        t.pageX - this.offset.click.left < i[0] &&
                            (n = i[0] + this.offset.click.left),
                        t.pageY - this.offset.click.top < i[1] &&
                            (r = i[1] + this.offset.click.top),
                        t.pageX - this.offset.click.left > i[2] &&
                            (n = i[2] + this.offset.click.left),
                    ...
                    s.grid &&
                        ...
                        (t = s.grid[0]
                            ? this.originalPageX +
                              Math.round((n - this.originalPageX) / s.grid[0]) *
                                  s.grid[0]
                            : this.originalPageX),
                        (n =
                            !i ||
        ...
        x.ui.plugin.add('draggable', 'scroll', {
            ...
            drag: function (t, e, i) {
                ...
                n !== r && 'HTML' !== n.tagName
                    ? ((s.axis && 'x' === s.axis) ||
                          (i.overflowOffset.top + n.offsetHeight - t.pageY <
                          s.scrollSensitivity
                              ? (n.scrollTop = o = n.scrollTop + s.scrollSpeed)
                              : t.pageY - i.overflowOffset.top <
                                    s.scrollSensitivity &&
                                (n.scrollTop = o =
                                    n.scrollTop - s.scrollSpeed)),
                      (s.axis && 'y' === s.axis) ||
                          (i.overflowOffset.left + n.offsetWidth - t.pageX <
                          s.scrollSensitivity
                              ? (n.scrollLeft = o =
                                    n.scrollLeft + s.scrollSpeed)
                    ...
                    : ((s.axis && 'x' === s.axis) ||
                          (t.pageY - x(r).scrollTop() < s.scrollSensitivity
                              ? (o = x(r).scrollTop(
                                    x(r).scrollTop() - s.scrollSpeed
                                ))
                              : x(window).height() -
                                    (t.pageY - x(r).scrollTop()) <
                                    s.scrollSensitivity &&
                                (o = x(r).scrollTop(
                                    x(r).scrollTop() + s.scrollSpeed
                                ))),
                      (s.axis && 'y' === s.axis) ||
                          (t.pageX - x(r).scrollLeft() < s.scrollSensitivity
                              ? (o = x(r).scrollLeft(
                                    x(r).scrollLeft() - s.scrollSpeed
                                ))
                              : x(window).width() -
                                    (t.pageX - x(r).scrollLeft()) <
                                    s.scrollSensitivity &&
                                (o = x(r).scrollLeft(
                                    x(r).scrollLeft() + s.scrollSpeed
                                )))),
        ...
        x.ui.plugin.add('draggable', 'snap', {
            ...
            drag: function (t, e, i) {
                for (
                    ...
                    (h =
                        (a = i.snapElements[_].left - i.margins.left) +
        ...
        _mouseStop: function (t) {
            ...
            return (
                this._helper &&
                    ...
                    o.animate ||
                        this.element.css(x.extend(e, { top: s, left: i })),
            ...
            start: function () {
                ...
                r &&
                    ...
                    /document/.test(n) || n === document
                        ...
                        : ((i = x(r)),
                          (s = []),
                          x(['Top', 'Right', 'Left', 'Bottom']).each(function (
                              t,
                              e
                          ) {
            ...
            resize: function () {
                ...
                ;(i.grid = a),
                    ...
                    /^(se|s|e)$/.test(r)
                        ...
                        ? ((e.size.width = u),
                          (e.size.height = d),
                          (e.position.top = n.top - p))
                        : /^(sw)$/.test(r)
                        ? ((e.size.width = u),
                          (e.size.height = d),
                          (e.position.left = n.left - c))
                        : ((d - l <= 0 || u - h <= 0) &&
                          ...
                          0 < u - h
                              ...
                              : ((u = h - t.width),
                                (e.size.width = u),
                                (e.position.left = n.left + o.width - u)))
            },
        })
    x.ui.resizable,
        x.widget('ui.sortable', x.ui.mouse, {
            ...
            _mouseCapture: function (t, e) {
                ...
                return (
                    ...
                    x(t.target)
                        .parents()
                        .each(function () {
                            if (x.data(this, o.widgetName + '-item') === o)
                                return (i = x(this)), !1
                        }),
                    !!(i =
                        x.data(t.target, o.widgetName + '-item') === o
                            ? x(t.target)
                            : i) &&
                        !(
                            this.options.handle &&
                ...
                return (
                    this.placeholder &&
                        ...
                        this.domPosition.prev
                            ...
                            : x(this.domPosition.parent).prepend(
                                  this.currentItem
                              )),
                    this
                )
            ...
            serialize: function (e) {
                ...
                return (
                    ...
                    x(t).each(function () {
                        var t = (
                            x(e.item || this).attr(e.attribute || 'id') || ''
            ...
            toArray: function (t) {
                ...
                return (
                    ...
                    e.each(function () {
                        i.push(
                            x(t.item || this).attr(t.attribute || 'id') || ''
                        )
                    }),
                    i
                )
            ...
            _intersectsWith: function (t) {
                ...
                return 'pointer' === this.options.tolerance ||
                    ...
                    : n < e + this.helperProportions.width / 2 &&
                          ...
                          o - this.helperProportions.height / 2 < h
            },
            ...
            _getItemsAsjQuery: function (t) {
                ...
                if (a && t)
                    for (e = a.length - 1; 0 <= e; e--)
                        for (
                            i = (s = x(a[e], this.document[0])).length - 1;
                            0 <= i;
                            i--
                        )
                            (o = x.data(s[i], this.widgetFullName)) &&
                                o !== this &&
                                !o.options.disabled &&
                                r.push([
            ...
            _refreshItems: function (t) {
                ...
                if (p && this.ready)
                    for (e = p.length - 1; 0 <= e; e--)
                        for (
                            i = (s = x(p[e], this.document[0])).length - 1;
                            0 <= i;
                            i--
                        )
                            (o = x.data(s[i], this.widgetFullName)) &&
                ...
                for (e = c.length - 1; 0 <= e; e--)
                    for (
                        n = c[e][1], h = (r = c[e][(i = 0)]).length;
                        i < h;
                        i++
                    )
                        (a = x(r[i])).data(this.widgetName + '-item', n),
                            l.push({
                                item: a,
                                instance: n,
                                width: 0,
                    ...
                    (e = this.items[s]),
                        (this.currentContainer &&
                            ...
                            ((i = this.options.toleranceElement
                                ? x(this.options.toleranceElement, e.item)
                                : e.item),
                            t ||
            ...
            _contactContainers: function (t) {
                for (
                    ...
                    x.contains(
                        ...
                        (this._intersectsWith(this.containers[u].containerCache)
                            ? (c &&
                                  x.contains(
                                      this.containers[u].element[0],
                                      c.element[0]
                                  )) ||
                              ((c = this.containers[u]), (p = u))
            ...
            _setContainment: function () {
                ...
                'parent' === i.containment &&
                    ...
                    /^(document|window|parent)$/.test(i.containment) ||
                        ...
                        (this.containment = [
                            e.left +
                                (parseInt(x(t).css('borderLeftWidth'), 10) ||
                                    0) +
                                (parseInt(x(t).css('paddingLeft'), 10) || 0) -
                                this.margins.left,
                            e.top +
                                (parseInt(x(t).css('borderTopWidth'), 10) ||
                                    0) +
        ...
        x.widget('ui.accordion', {
                        ...
                        o ||
                            ...
                            e.icons &&
                                ...
                                this._removeClass(
                                    ...
                                    null,
                                    e.icons.header
                                )._addClass(o, null, e.icons.activeHeader)),
                            this._addClass(
                                s.next(),
                                'ui-accordion-content-active'
                            )))
                        ...
                        : e.length &&
                          this.headers
                              .filter(function () {
                                  return (
                                      0 ===
                                      parseInt(x(this).attr('tabIndex'), 10)
                                  )
                              })
                              .attr('tabIndex', -1),
            ...
            _animate: function (t, i, e) {
                ...
                return (
                    (o =
                        (o = 'string' == typeof p ? p : o) ||
                        p.easing ||
                        c.easing),
                    (n =
                        (n = 'number' == typeof p ? p : n) ||
                        p.duration ||
                        c.duration),
                    i.length
                        ? t.length
                            ...
                            : i.animate(this.hideProps, n, o, l)
                        : t.animate(this.showProps, n, o, l)
                )
            },
            ...
            x.each(this.options.items, function (s, t) {
                ...
                if (t)
                    return 'controlgroupLabel' === s
                        ? ((e = n.element.find(t)).each(function () {
                              var t = x(this)
                        ...
                        : void (
                              ...
                              n.element.find(t).each(function () {
                                  ...
                                  ;('button' === s &&
                                      ...
                                      ((e = e || t[s]()[s]('instance')) &&
                                          (i.classes = n._resolveClassesValues(
                                              i.classes,
                                              e
                                          )),
                                      t[s](i),
                ...
                (this.childWidgets = x(x.uniqueSort(r))),
            ...
            this._addClass(
                ...
                (o = this.options.onlyVisible ? o.filter(':visible') : o)
                    ...
                    (x.each(['first', 'last'], function (t, e) {
                        var i,
                            s = o[e]().data('ui-controlgroup-data')
                        s && n['_' + s.widgetName + 'Options']
                            ? (((i = n['_' + s.widgetName + 'Options'](
                                  1 === o.length ? 'only' : e
                              )).classes = n._resolveClassesValues(
                                  i.classes,
                                  s
                              )),
                              s.element[s.widgetName](i))
                            : n._updateCornerClass(o[e](), e)
                    }),
    ...
    x.widget('ui.dialog', {
        ...
        _createButtonPane: function () {
            ;(this.uiDialogButtonPane = x('<div>')),
                ...
                (this.uiButtonSet = x('<div>').appendTo(
                    this.uiDialogButtonPane
                )),
